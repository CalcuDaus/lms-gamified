...
@section('content')
    <div class="max-w-[600px] mx-auto mt-10 bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-custom font-balo">
        <h2 class="text-2xl font-semibold mb-6 text-center dark:text-gray-100">Create New User</h2>
        <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            {{-- Password --}}
            <div>
                <label for="password" class="block mb-1 font-medium dark:text-gray-200">Password</label>
            ...
            <div>
                <label for="password_confirmation" class="block mb-1 font-medium dark:text-gray-200">Password Confirmation</label>
