        ...
        <section class="flex w-full mt-10 justify-between items-end">
            <div class="flex w-[288px] h-[148px] rounded-3xl items-center  justify-center overflow-hidden shadow-custom"
                ...
                <div class="p-6 flex flex-col text-[#ff4036] items-center relative justify-center ">
                    ...
                    <p class="text-6xl font-black">{{ $coursesTaken ?? '0' }}</p>
                    <i style="animation-delay: 400ms"
                        class="fa-brands fa-gripfire text-[#ff4036a9] animate-bounce absolute text-[135px] z-1 -bottom-13 -right-[125px] blur-[1px] "></i>
                </div>
            </div>
        ...
        <section class="flex w-full mt-10">
            <div class="flex w-[55%] flex-col gap-6">
                ...
                <div class="flex gap-2 flex-col text-gray-600 dark:text-[#EEEEEE] shadow-custom rounded-3xl p-6"
                    ...
                    <h3 class="font-black">Hello, {{ Auth::user()->name }}</h3>
                    <div class="flex justify-between items-center">
                        <h4 class="font-bold">Let's continue learning</h4>
                        <a href="#"
                            class="relative inline-flex  items-center justify-center px-5 py-2 overflow-hidden tracking-tighter text-white bg-orange-600 rounded-xl group">
                            <span
                                class="absolute w-0 h-0 transition-all duration-600 ease-out bg-blue-600 rounded-full group-hover:w-56 group-hover:h-56"></span>
                            ...
                            <span class="relative text-base font-semibold">Go to Courses</span>
                        </a>
                    </div>
                </div>
                {{-- Widget Progress --}}
                <div class="flex gap-2 flex-col text-gray-600 dark:text-[#EEEEEE] shadow-custom rounded-3xl p-6"
                    ...
                    <div class="w-full h-3 bg-gray-400 rounded-full mt-2 overflow-hidden">
                        <div class="h-3 flex justify-center bg-[#00d45c] rounded-full w-3/4">
                            <div class="h-[3px] animate-pulse translate-y-0.5 bg-[#64ffa7] rounded-full w-[98%]">
                            </div>
                        </div>
                    </div>
            ...
            <div class="flex w-[45%] ps-6">
                {{-- Widget Leaderboards --}}
                <div class="flex gap-2 w-full h-max flex-col text-gray-600 dark:text-[#EEEEEE] shadow-custom rounded-3xl p-6"
                    style="--color-shadow:#9b9b9b;">
