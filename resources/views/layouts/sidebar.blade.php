<aside class="hidden md:flex fixed top-0 flex-col w-20 h-dvh ">
    <div class="absolute top-4 left-4">
        <img src="{{ asset('assets/img/logo-project.png') }}" width="44px" alt="Logo" loading="lazy">
    </div>
    <nav class="h-full flex justify-center items-center">
        <ul class="flex flex-col gap-5 text-2xl ">
            ...
            @role('student')
                <li data-tippy-content="{{ __('messages.dashboard') }}"
                ...
                <li data-tippy-content="{{ __('messages.courses') }}"
                ...
                <li data-tippy-content="{{ __('messages.leaderboard') }}"
                    class="nav-item {{ request()->is('leaderboard') ? 'active' : '' }} transition-all duration-300 px-3 py-2 rounded-md active:shadow-none active:translate-y-0.5"
                    style="--color-main:#ff4136; --color-shadow:#c32d25;"><a href="{{ route('student.leaderboard') }}"><i
                            class="fa-solid fa-trophy"></i></a></li>
                <li data-tippy-content="{{ __('messages.settings') }}"
                    class="nav-item {{ request()->is('settings') ? 'active' : '' }} transition-all duration-300 px-3 py-2 rounded-md active:shadow-none active:translate-y-0.5"
                    style="--color-main:#848484; --color-shadow:#3f3f3f;"><a href="{{ route('settings') }}"><i
            ...
            @elserole('admin')
                    ...
                    <li data-tippy-content="{{ __('messages.users') }}"
                    ...
                    <li data-tippy-content="{{ __('messages.badges') }}"
                    ...
                    <li data-tippy-content="{{ __('messages.materials') }}"
                ...
                <li data-tippy-content="{{ __('messages.my_courses') }}"
